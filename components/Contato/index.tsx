...
import { ContactGroup } from "@/types/pages/home";

export const Contato = ({ data }: { data: ContactGroup }) => {
    const openContato = useUiStore((s) => s.openContato);
            ...
            <div className="relative z-10 container text-center">
                ...
                >
                    ...
                    >
                        ...
                        {!data.habilitar_botao_do_whatsapp &&
                            "Entrar em contato"}
                    </button>
                    {data.habilitar_botao_do_whatsapp && (
                        <Link
                            ...
                            href={data.url_whatsapp.url}
                            target={data.url_whatsapp.target || "_self"}
                        >
                            <svg
                                className="size-5"
                                viewBox="0 0 24 24"
